...
class ToolRegistry:
    ...
    """
    def __init__(self, tool_name_list:List):

        self.tool_list = []
        for tool_name in tool_name_list:
            if tool_name not in

    def add_tool(self, tool_name) -> None:
        self.tool_name_list.append(tool_name)

    def remove_tool(self, tool_name) -> None:
        self.tool_name_list.remove(tool_name)

    def get_tool(self, tool_name) -> bool:
        return  self.tool_list[tool_name]

    def get_all_tool_info(self) -> List:
        return self.tool_info_list
